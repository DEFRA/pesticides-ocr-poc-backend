...
```bash
docker build --no-cache --tag pesticides-ocr-poc-backend .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 pesticides-ocr-poc-backend
```
